...
from deutschland.entgeltatlas import rest
...
from deutschland.entgeltatlas.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.entgeltatlas  # this is an instance of the class Endpoint
        api_instance.entgeltatlas()  # this invokes api_instance.entgeltatlas.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.entgeltatlas.callable or self.callable in this class
